...
l1_file_list[[1]]  = "../DMS_data/Bgl3/Bgl3_Lib1_sel1_sequences_filtered.txt.gz"
l1_file_list[[2]]  = "../DMS_data/Bgl3/Bgl3_Lib1_sel2_sequences_filtered.txt.gz"
l1_file_list[[3]]  = "../DMS_data/Bgl3/Bgl3_Lib1_sel3_sequences_filtered.txt.gz"

l1_seq_l = gen_seq_l(l1_file_list)
l1_seq_u = fread("../DMS_data/Bgl3/Bgl3_Lib1_ref_sequences_filtered.txt.gz",header=F)

Bgl3_LT = create_protein_dat_from_seq(seq_l = l1_seq_l,seq_u = l1_seq_u)

# Library2
l2_file_list = vector("list",2)
l2_file_list[[1]]  = "../DMS_data/Bgl3/Bgl3_Lib2_sel1_sequences_filtered.txt.gz"
l2_file_list[[2]]  = "../DMS_data/Bgl3/Bgl3_Lib2_sel2_sequences_filtered.txt.gz"

l2_seq_l = gen_seq_l(l2_file_list)
l2_seq_u = fread("../DMS_data/Bgl3/Bgl3_Lib2_ref_sequences_filtered.txt.gz", header=F)
Bgl3_HT_1 = create_protein_dat_from_seq(seq_l = l2_seq_l, seq_u = l2_seq_u)

# Library3
l3_file_list = vector("list",3)
l3_file_list[[1]]  = "../DMS_data/Bgl3/Bgl3_Lib3_sel1_sequences_filtered.txt.gz"
l3_file_list[[2]]  = "../DMS_data/Bgl3/Bgl3_Lib3_sel2_sequences_filtered.txt.gz"
l3_file_list[[3]]  = "../DMS_data/Bgl3/Bgl3_Lib3_sel3_sequences_filtered.txt.gz"

l3_seq_l = gen_seq_l(l3_file_list)
l3_seq_u = fread("../DMS_data/Bgl3/Bgl3_Lib3_ref_sequences_filtered.txt.gz", header=F)
