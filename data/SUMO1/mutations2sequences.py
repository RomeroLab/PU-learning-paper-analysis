...
# filenames                                                                                                                                                                                                                      
rcfile = 'SUMO1_ref_read_counts.txt' # this is to get the reference sequence 
reffile = 'SUMO1_ref_mutations_filtered.txt'
selfile = 'SUMO1_sel_mutations_filtered.txt'
