...
# filenames                                                                                                                                                                                                                      
rcfile = 'UBE2I_ref_read_counts.txt' # this is to get the reference sequence 
reffile = 'UBE2I_ref_mutations_filtered.txt'
selfile = 'UBE2I_sel_mutations_filtered.txt'
